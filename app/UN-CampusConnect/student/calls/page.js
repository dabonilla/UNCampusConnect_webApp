          ...
          {calls.map((call, index) => (
            <tr key={call.nameGroup}>
              <td className='text-center'>
                <button type="button" onClick={() => handleShow(index)} className="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-text-fill" viewBox="0 0 16 16">
