  ...
  export default function Tutor() {
    ...
    function Sidebar({ handleShowForm }) {
            ...
            <div className=" flex justify-between items-center w-full">
              <div className="flex justify-center items-center  space-x-2">
                ...
                <div className="flex justify-center flex-col items-center">
                  <p className="text-sm leading-5 mb-0 text-white">Alexis Enache</p>
                  <p className="text-xs leading-3 mb-0 text-gray-300">alexis81@gmail.com</p>
                </div>
              </div>
    ...
    function Form() {
      ...
      `;
      axios.post(endpoint, { query: createTutor })
          .then(response => {
      ...
      return (
        <div style={{ margin: '15px 0'}} className={`bg-white rounded flex items-center justify-center shadow-lg p-2 px-2  ${showForm ? '' : 'hidden'}`}>
    ...
    return (
      <div sytle={{ height:'fit-content'}} className="flex">
        ...
        <div style={{ display: 'grid', height: 'fit-content', justifyContent: 'center', alignItems: 'center', flexGrow: 1 }} >
          {showForm && <Form />}
        </div>
      </div>
    );
